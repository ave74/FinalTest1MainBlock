1. Создаём массивы array1 и array2. Размер array2 такой же как и array1 - на случай если все элементы массива array1 будут меньше, либо равны 3. При создании задаём значения массива array1.
